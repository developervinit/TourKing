...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false //center: [-118.113491, 34.111745], //first longitute then latitute
    //zoom: 8,
    //interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //adding popup. it show the location name on map 
...
//this file is to hide alert messages
//hiding alert messages 
...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, 5000); //hideAlert() fun will run after 5 second 
};
...
//exporting login from here to index.js. this 'export' syntax belongs to es6
...
}(); //exporting logout from here to index.js
...
var stripe = Stripe('pk_test_51Hev6NLgZUJ3DKG68LXkc220uscBYzM0GJ5kYhs4F1QR0YlcMBOMR0y2J2CSq1RXK8TIWPcB3sk7Br8ATsGIfyxX00plR6Sid8'); //when in tour.pug you click 'Book tour now!' btn then this 'tourId' function triggers 
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); //multi form 
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //on clicking save password btn, btn's textContent will change to 'Upadating....'

            document.querySelector('.btn--save-password').textContent = 'Upadating....';
            passwordCurrent = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value; //updateSettings() is awaited then further code will not block to execute. it is asynchronous way 
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  (0, _stripe.bookTour)(tourId); //bookTour function is in stripe.js
});
